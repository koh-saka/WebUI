...
(function ($) {
    ...
    $.alerts = {
        ...
        _reposition: function () {
            ...
            var top,left;
            // if(isMobile){
            //     top = ((1210/currentZoomValue/2) - ($("#popup_container").outerHeight() / 2)) + $.alerts.verticalOffset;
            //     //left = ((1920/currentZoomValue / 2) - ($("#popup_container").outerWidth() / 2)) + $.alerts.horizontalOffset;
            // }else{
            //     top = (($(window).height()/currentZoomValue/2) - ($("#popup_container").outerHeight() / 2)) + $.alerts.verticalOffset;
            //     //left = (($(window).width()/currentZoomValue / 2) - ($("#popup_container").outerWidth() / 2)) + $.alerts.horizontalOffset;
            // }
            try{
                if($("#popup_content").hasClass("confirmIcon")||window.location.href.indexOf('register') != -1){
                    top = "25%";
                }else{
                    top = $("#setupDiv").position().top/currentZoomValue+500 + "px";
                }
